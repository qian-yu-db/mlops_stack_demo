...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_stack_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-dogfood.staging.cloud.databricks.com/explore/data/models/staging/mlops_stack_demo/mlops_stack_demo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops_stack_demo/mlops_stack_demo-model)
. 
